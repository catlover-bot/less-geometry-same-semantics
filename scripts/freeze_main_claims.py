"""Freeze only supported paper claims from completed run records."""
...
def main() -> None:
    ...
    report = freeze_supported_claims(main_record, severity_record)
    save_frozen_claims(report, args.output_dir)
